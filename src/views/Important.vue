<template>
    <keep-alive>
        <content-view chosenSmartList="important" ref="tasksParent" :class="[toggleShrink ? 'shrink' : 'grow']" :key="listId">
    ...
    <transition name="to-left" :css="animated">
        <TaskDescription :key="descriptionTaskIndex" :toggleShrink="toggleShrink"
            ...
            v-if="toggleShrink" :element="element" chosenSmartList="important" />
    </transition>
