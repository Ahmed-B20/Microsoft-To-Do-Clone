<template>
    <keep-alive>
        <content-view chosenSmartList="tasks" ref="tasksParent" :class="[toggleShrink ? 'shrink' : 'grow']" :key="listId">
            ...
            <template #allTaskSlot>
                <SingleTask :toggleShrink="toggleShrink" @openDescriptionEvent="openDescription" :childId="childId" chosenSmartList="tasks" />
            </template>
        </content-view>
    </keep-alive>
    ...
    <transition name="to-left" :css="animated">
        <TaskDescription :key="descriptionTaskIndex" :toggleShrink="toggleShrink"
            ...
            v-if="toggleShrink" :element="element" chosenSmartList="tasks" />
    </transition>
...
export default {
    ...
    methods: {
        ...
        openDescription(listId, index, shrink, element) {
            ...
            if (!!this.smartList['tasks'].tasks[index].childListId) {
                this.descriptionTaskChildList = this.smartList['tasks'].tasks[index].childListId
            }
            this.descriptionTaskList = this.smartList['tasks'].tasks[index].listId
            this.descriptionTaskIndex = this.smartList['tasks'].tasks[index].id
